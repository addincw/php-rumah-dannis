...
$insert=insertPesan($id_order, $ID_KONS, $ID_KAR, $TGL_PSN, $STATUS_PSN = NULL, $KONFIRMASI_PSN = NULL, $total, $jenis_psn = 1);
        ...
        unset($_SESSION['total_order']);
				...
				header("location:keranjang_order.php");
				}
