...
<div class="w3-container w3-padding-32" style="margin-top:55px;">
  ...
  <div class="w3-container w3-card w3-white">
    <h3 class="w3-border-bottom w3-border-black w3-padding-12">Status retur</h3>
    <p>cek status retur anda, dengan memasukkan nomor pembelian yang tertera pada nota.</p>
    <form>
